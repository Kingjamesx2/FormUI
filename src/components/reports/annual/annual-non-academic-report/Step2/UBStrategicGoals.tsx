...
import { selectStrategicGoals, setStrategicGoals } from "../../../../../store/features/annualNonReportSlice";
    ...
    <Container sx={{ width: 1, m: 1, p: 1 }}>
      ...
      <Box mb={-4.5}>
        <UBTextArea
          ...
          value={strategicGoals.strategicGoalsUnderReview}
        />
      </Box>
      ...
      <Box mb={-4.5}>
        <UBTextArea
          ...
          value={strategicGoals.implmentationPlans}
        />
      </Box>
      ...
      <Box mb={-4.5}>
        <UBTextArea
          ...
          value={strategicGoals.plansToAchieveNotCompletedGoals}
        />
      </Box>
      ...
      <Box mb={-4.5}>
        <UBTextArea
          ...
          value={strategicGoals.strategicGoals}
        />
      </Box>
    </Container>
  );
